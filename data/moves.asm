...
Gen6Moves::
	...
	move SWORDS_DANCE, ATTACK_UP2_EFFECT,                    0, NORMAL,    PERF, 20
	move CUT,          NO_ADDITIONAL_EFFECT,                50, NORMAL,      95, 30
	move GUST,         NO_ADDITIONAL_EFFECT,                40, FLYING,     100, 35
	move WING_ATTACK,  NO_ADDITIONAL_EFFECT,                60, FLYING,     100, 35
	move WHIRLWIND,    SWITCH_AND_TELEPORT_EFFECT,           0, NORMAL,    PERF, 20
	...
	move GROWL,        ATTACK_DOWN1_EFFECT,                  0, NORMAL,     100, 40
	move ROAR,         SWITCH_AND_TELEPORT_EFFECT,           0, NORMAL,    PERF, 20
	move SING,         SLEEP_EFFECT,                         0, NORMAL,      55, 15
	move SUPERSONIC,   CONFUSION_EFFECT,                     0, NORMAL,      55, 20
	move SONICBOOM,    SPECIAL_DAMAGE_EFFECT,                1, NORMAL,      90, 20
	...
	move MIST,         MIST_EFFECT,                          0, ICE,       PERF, 30
	move WATER_GUN,    NO_ADDITIONAL_EFFECT,                40, WATER,      100, 25
	...
	move LEECH_SEED,   LEECH_SEED_EFFECT,                    0, GRASS,       90, 10
	move GROWTH,       SPECIAL_UP1_EFFECT,                   0, NORMAL,    PERF, 20
	move RAZOR_LEAF,   NO_ADDITIONAL_EFFECT,                55, GRASS,       95, 25
	move SOLARBEAM,    CHARGE_EFFECT,                      120, GRASS,      100, 10
	move POISONPOWDER, POISON_EFFECT,                        0, POISON,      75, 35
	move STUN_SPORE,   PARALYZE_EFFECT,                      0, GRASS,       75, 30
	...
	move PSYCHIC_M,    SPECIAL_DOWN_SIDE_EFFECT,            90, PSYCHIC,    100, 10
	move HYPNOSIS,     SLEEP_EFFECT,                         0, PSYCHIC,     60, 20
	move MEDITATE,     ATTACK_UP1_EFFECT,                    0, PSYCHIC,   PERF, 40
	move AGILITY,      SPEED_UP2_EFFECT,                     0, PSYCHIC,   PERF, 30
	move QUICK_ATTACK, NO_ADDITIONAL_EFFECT,                40, NORMAL,     100, 30
	move RAGE,         RAGE_EFFECT,                         20, NORMAL,     100, 20
	move TELEPORT,     SWITCH_AND_TELEPORT_EFFECT,           0, PSYCHIC,   PERF, 20
	move NIGHT_SHADE,  SPECIAL_DAMAGE_EFFECT,                0, GHOST,      100, 15
	move MIMIC,        MIMIC_EFFECT,                         0, NORMAL,    PERF, 10
	move SCREECH,      DEFENSE_DOWN2_EFFECT,                 0, NORMAL,      85, 40
	move DOUBLE_TEAM,  EVASION_UP1_EFFECT,                   0, NORMAL,    PERF, 15
	move RECOVER,      HEAL_EFFECT,                          0, NORMAL,    PERF, 10
	move HARDEN,       DEFENSE_UP1_EFFECT,                   0, NORMAL,    PERF, 30
	move MINIMIZE,     EVASION_UP1_EFFECT,                   0, NORMAL,    PERF, 10
	move SMOKESCREEN,  ACCURACY_DOWN1_EFFECT,                0, NORMAL,     100, 20
	move CONFUSE_RAY,  CONFUSION_EFFECT,                     0, GHOST,      100, 10
	move WITHDRAW,     DEFENSE_UP1_EFFECT,                   0, WATER,     PERF, 40
	move DEFENSE_CURL, DEFENSE_UP1_EFFECT,                   0, NORMAL,    PERF, 40
	move BARRIER,      DEFENSE_UP2_EFFECT,                   0, PSYCHIC,   PERF, 20
	move LIGHT_SCREEN, LIGHT_SCREEN_EFFECT,                  0, PSYCHIC,   PERF, 30
	move HAZE,         HAZE_EFFECT,                          0, ICE,       PERF, 30
	move REFLECT,      REFLECT_EFFECT,                       0, PSYCHIC,   PERF, 20
	move FOCUS_ENERGY, FOCUS_ENERGY_EFFECT,                  0, NORMAL,    PERF, 30
	move BIDE,         BIDE_EFFECT,                          0, NORMAL,    PERF, 10
	move METRONOME,    METRONOME_EFFECT,                     0, NORMAL,    PERF, 10
	move MIRROR_MOVE,  MIRROR_MOVE_EFFECT,                   0, FLYING,    PERF, 20
	...
	move SWIFT,        SWIFT_EFFECT,                        60, NORMAL,    PERF, 20
	move SKULL_BASH,   CHARGE_EFFECT,                      130, NORMAL,     100, 10
	move SPIKE_CANNON, TWO_TO_FIVE_ATTACKS_EFFECT,          20, NORMAL,     100, 15
	move CONSTRICT,    SPEED_DOWN_SIDE_EFFECT,              10, NORMAL,     100, 35
	move AMNESIA,      SPECIAL_UP2_EFFECT,                   0, PSYCHIC,   PERF, 20
	move KINESIS,      ACCURACY_DOWN1_EFFECT,                0, PSYCHIC,     80, 15
	move SOFTBOILED,   HEAL_EFFECT,                          0, NORMAL,    PERF, 10
	...
	move LOVELY_KISS,  SLEEP_EFFECT,                         0, NORMAL,      75, 10
	move SKY_ATTACK,   CHARGE_EFFECT,                      140, FLYING,      90, 5
	move TRANSFORM,    TRANSFORM_EFFECT,                     0, NORMAL,    PERF, 10
	...
	move SPLASH,       SPLASH_EFFECT,                        0, NORMAL,    PERF, 40
	move ACID_ARMOR,   DEFENSE_UP2_EFFECT,                   0, POISON,    PERF, 20
	move CRABHAMMER,   NO_ADDITIONAL_EFFECT,               100, WATER,       90, 10
	move EXPLOSION,    EXPLODE_EFFECT,                     250, NORMAL,     100, 5
	move FURY_SWIPES,  TWO_TO_FIVE_ATTACKS_EFFECT,          18, NORMAL,      80, 15
	move BONEMERANG,   ATTACK_TWICE_EFFECT,                 50, GROUND,      90, 10
	move REST,         HEAL_EFFECT,                          0, PSYCHIC,   PERF, 10
	move ROCK_SLIDE,   NO_ADDITIONAL_EFFECT,                75, ROCK,        90, 10
	move HYPER_FANG,   FLINCH_SIDE_EFFECT1,                 80, NORMAL,      90, 15
	move SHARPEN,      ATTACK_UP1_EFFECT,                    0, NORMAL,    PERF, 30
	move CONVERSION,   CONVERSION_EFFECT,                    0, NORMAL,    PERF, 30
	move TRI_ATTACK,   NO_ADDITIONAL_EFFECT,                80, NORMAL,     100, 10
	move SUPER_FANG,   SUPER_FANG_EFFECT,                    1, NORMAL,      90, 10
	move SLASH,        NO_ADDITIONAL_EFFECT,                70, NORMAL,     100, 20
